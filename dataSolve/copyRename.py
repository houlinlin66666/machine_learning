...
if __name__ == '__main__':
    batch_rename_and_copy(
        label_file=r'/Users/houlinlin/master/data/EEM_data/yan/yan(1)/blank/huan/excel/over/label.xlsx',  # 你的 label 文件路径
        source_dir=r'/Users/houlinlin/master/data/EEM_data/yan/yan(1)/blank/yang/excel/over',  # 原始样品文件所在的文件夹
        output_dir=r'/Users/houlinlin/master/data/EEM_data/yan/yan(1)/blank/yang/excel/rename'  # 处理后存放的文件夹
    )